...
# Layout
An instance of ofxTimeline and contains any number of elements that can be edited along the duration.  It also has organizational elements such as support for multiple pages, time ticker, and view zooming.
